                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body" style="width: 50%;">
                                ...
                                <div class="panel-body">
                                    <form action="../SettingController/Add" >
<!--                                        <div class="row ">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <input  type="radio" name="foo" value="true" id="rbStatus" checked="checked"> <span style="margin-right: 2rem;" >Active</span>
                                                <input type="radio" name="foo" value="false" id="rbStatus" > Deactivate

                                            </div>
                                        </div>
                                        <div class=" form-group row col-lg-12 text-center">
                                            <button type="submit" id="submit-btn" class="btn btn-info"  >Add Setting</button>
                                        </div>
                                    </form>
