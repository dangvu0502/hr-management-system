                                            ...
                                            <div class="col-lg-8">
                                                <div class="row ">
                                                    <div class="form-group col-lg-12">
                                                        <label>Code</label>
                                                        <input value="${g.code}" name="code" type="text" class="form-control" readonly required>
                                                    </div>
                                                </div>
                                                <div class="row ">
                                                    <div class="form-group col-lg-12">
                                                        <label>Name</label>
                                                        <input value="${g.name}" name="name" type="text" class="form-control" readonly required>
                                                    </div>
                                                </div>
                                                <div class="row ">
                                                     <div class="form-group col-lg-12">
                                                        <label>Manager</label>
                                                        <input value="${g.manager}" name="manager" type="text" class="form-control" readonly required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
