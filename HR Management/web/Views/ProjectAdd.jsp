                                            ...
                                            <div class="col-lg-8">
                                                <div class="row ">
                                                    <div class="form-group col-lg-12">
                                                        <label for="code">Code</label><i style="color: red; font-size: 20px">*</i>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
                                                        <label for="projectName">Project Name</label><i style="color: red; font-size: 20px">*</i>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <h5 style="color: red"><i>By add new project, start date will set from now on....<br/>Otherwise you can edit it later</i></h5>
                                                        <input type="date" class="form-control" name="startDate1" value="${date}" disabled="">
                                                        <input name="startDate" value="${date}" hidden="">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
                                                        <label for="endDate">End Date</label><i style="color: red; font-size: 20px">*</i>
                                                        <input type="date" class="form-control" name="endDate" value="${p.endDate}" required="">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
                                                ...
                                                <div class=" form-group row col-lg-12 text-center">
                                                    <button type="submit" id="submit-btn" class="btn btn-info"  >Add Project</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
