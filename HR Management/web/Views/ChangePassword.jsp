                    ...
                    <div class="col-lg-6 ">
                        <section class="panel">
                            ...
                            <c:if test="${message != null}">
                                <div class="error alert ${sessionScope.message eq 'Wrong old password' ?'alert-danger':'alert-success'}" role="alert">
                            ...
                            <div class="panel-body">
                                <form action="../User/ChangePassword" method="POST" role="form" onsubmit="return isValid">
                                    <div class="row">
                                        <div class="col-lg-2"></div>
                                        <div class="col-lg-8">
                                            <input name="username" hidden="" value="${sessionScope.account.username}">
                                            <div class="row ">
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <input type="password" class="form-control" id="password" name="newpassword" onkeyup="checkEqual()" placeholder="Enter your password"  required >
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="form-group col-lg-12">
