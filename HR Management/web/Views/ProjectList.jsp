    ...
    <body class="skin-black">
                                ...
                                <div class="panel-body table-responsive">
                                    <div class="box-tools m-b-15">
                                        <div class="row">
                                                        ...
                                                        <div id="advanced" style="display: none">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="text-left" for="pmFilter" style="width: 150px;">Project Manager</label><br>
                                                                        <select class="form-control input-md" style="width: 200px;" name="pmFilter" id="pmFilter">
                                                                            <option value="">Choose Project Manager</option>
                                                                            <c:forEach var="pm" items="${projectManager}">
                                            ...
                                            <div class="col-lg-2"></div>
                                            <div class="col-lg-2">
                                                <button onclick="window.open('http://localhost:8080/HR_Management/Project/Add', '_blank')" class="btn btn-md btn-primary" style="width: 150px; ">Add new project</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach var="project" items="${projectList}"  varStatus="theCount">
                                                <tr id="contract${project.code}">
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-md btn-default" onclick="window.open('http://localhost:8080/HR_Management/Project/Edit?code=${project.code}', '_blank')" ><i class="fa fa-pencil"></i></a>
        ...
        <script>
            ...
            function page(number) {
                ...
                var pm = document.getElementById('pmFilter').value;
                var status = document.getElementById('statusFilter').value;
                var search = document.getElementById('projectSearch').value;
                var link = "http://localhost:8080/HR_Management/Project/List?";
